...
# Kepler
kepler_raw = pd.read_csv('ml/datasets/raw/kepler_objects_of_interest_koi.csv')
...
# Tess
tess_raw = pd.read_csv('ml/datasets/raw/tess_objects_of_interest_toi.csv')
...
# K2
k2_raw = pd.read_csv('ml/datasets/raw/k2_planets_and_candidates.csv')
...
# Save datasets
kepler.to_csv('ml/datasets/cleaned/kepler.csv', index=False)
tess.to_csv('ml/datasets/cleaned/tess.csv', index=False)
k2.to_csv('ml/datasets/cleaned/cleaned/k2.csv', index=False)